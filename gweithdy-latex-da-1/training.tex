...
\furtherinfo*[%
  ...
  \begin{itemize}
    ...
    \item .
  \end{itemize}
  \item Appendix \ref{handouts:sec:}: sample output for exercise \ref{handouts:ex:}.
  \item Appendix \ref{handouts:sec:}: .
  \item Appendix \ref{handouts:sec:}: .
]
\mode*
...
The remainder of this section concentrates on the choice of \TeX{} distribution.
...
\subsubsection<1-| beamer:0>{Pre-Installation}
