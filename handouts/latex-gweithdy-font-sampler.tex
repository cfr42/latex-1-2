...
\svnidlong
{$HeadURL: file:///mnt/between/svn/dysgu/trunk/DoctoralAcademy/gweithdai-latex/handouts/latex-gweithdy-font-sampler.tex $}
{$LastChangedBy: cfrees $}
{$LastChangedRevision: 10060 $}
{$LastChangedDate: 2024-05-16 01:56:21 +0100 (Iau, 16 Mai 2024) $}
% best not to mix \svnid and \svnidlong (or to always typeset time-zone with time? see documentation)
%	\svnid{$Id: latex-gweithdy-font-sampler.tex 10060 2024-05-16 00:56:21Z cfrees $}
...
\enwffont{cantarell-OsF}{Cantarell}
\enwffont{Crlt-TLF}{Carlito}
...
\enwffont{Merriwthr-OsF}{Merriweather}
...
\enwffont{opensans-TLF}{OpenSans}
\enwffont{Ovrlck-LF}{Overlock}
